...
Python is a **general purpose, interpreted, high-level programming language** that you can use effectively to build almost any kind of program that does not need direct access to the computer's hardware. 
 
```{tip}
In this book, we use `Python`, however, this book is not meant to be about Python. It will certainly help us learn Python, and that's a good thing. But....

What is much more important is that we will learn how to write programs that solve problems. Once we figure that out then we can transfer our skill to any programming language.
```